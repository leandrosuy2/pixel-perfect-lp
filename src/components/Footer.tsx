...
/** Substitua pelos perfis reais da AZ Chat. */
const SOCIAL_LINKS = [
      ...
      <div className="container mx-auto space-y-5 px-6 py-5 md:py-6">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:items-center">
          <div className="flex flex-wrap items-center justify-center gap-2 md:justify-start">
            <span className="mr-2 text-xs font-medium text-muted-foreground">Redes:</span>
          ...
          <Link
            ...
            className="text-center text-xs text-muted-foreground underline-offset-4 transition-colors hover:text-primary hover:underline"
          >
